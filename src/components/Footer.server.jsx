...
export default function Footer({collections,products}) {
  return (
    <footer role="contentinfo">
      <div className="relative border-t border-b border-black bg-white border-opacity-5">
        <div className="mx-auto max-w-7xl px-4 py-14 md:px-8 grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            <h2 className="text-base font-medium uppercase mb-4">Community</h2>
          ...
          <div>
            ...
            <ul className="mt-8 space-y-4">
              ...
              <li className="flex items-center text-sm font-medium text-gray-600 hover:text-gray-900">
                <Link to={`/products/${products?.handle}`}>Product</Link>
              </li>
              <li className="flex items-center text-sm font-medium text-gray-600 hover:text-gray-900">
                <Link to={`/collections/${collections?.handle}`}>Collection</Link>
              </li>
              <li className="flex items-center text-sm font-medium text-gray-600 hover:text-gray-900">
          ...
          <div>
            ...
            <ul className="mt-8 space-y-4">
              ...
              <li className="flex items-center text-sm font-medium text-gray-600 hover:text-gray-900">
                <a href='https://shopify.dev/custom-storefronts/hydrogen/templates'>Demo store template</a>
              </li>
            </ul>
          </div>
        </div>
